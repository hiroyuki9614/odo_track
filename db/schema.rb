...
ActiveRecord::Schema[7.1].define(version: 20_231_219_094_524) do
  create_table 'daily_logs', force: :cascade do |t|
    ...
    t.index %w[user_id created_at], name: 'index_daily_logs_on_user_id_and_created_at'
  ...
  create_table 'favorite_vehicles', force: :cascade do |t|
    ...
    t.integer 'vehicle_id', null: false
    t.text 'favorite_vehicle_note', default: '', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
  ...
  create_table 'vehicles', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.datetime 'discarded_at'
    t.index %w[vehicle_name number manufacture],
            name: 'index_vehicles_on_vehicle_name_and_number_and_manufacture', unique: true
  end
