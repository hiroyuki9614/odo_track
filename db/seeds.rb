...
unless Rails.env.production? && ENV['ALLOW_PRODUCTION_SEEDS'] != 'true'
  require 'faker'
  require 'securerandom'

  seed_password = ENV.fetch('SEED_PASSWORD') { SecureRandom.base58(24) }
  ...
  ApplicationRecord.transaction do
    ...
    5.times do |_n|
      Vehicle.create!(
        vehicle_name: Faker::Vehicle.model.to_s[0, 20],
        number: rand(0...9999),
        manufacture: Faker::Vehicle.manufacture.to_s[0, 20],
