	...
	<v-app>
		<v-toolbar color="gray">
			...
			<v-menu>
				...
				<v-list>
					<v-list-item v-for="link in links" :base-color="link.color" :key="link.title" :to="link.url" :title="link.title" :prepend-icon="link.icon" @click="link.title === 'ログアウト' ? logout() : handleClick(link)">
...
const links = [
	...
	{title: '操作方法', icon:'mdi mdi-help-circle', url:'/user_help'},
